...
void setup()
{
  ...
  nh.subscribe(toggle_sub); //ADDED 7/25 SD
  ...
  //digitalWrite(BDPIN_GPIO_2, HIGH); //For testing
...
/*******************************************************************************
* Callback function for toggle_led ADDED 7/25/22 SD
* see https://emanual.robotis.com/docs/en/parts/controller/opencr10/#install-on-linux
* LED_PIN defined at top
*******************************************************************************/
